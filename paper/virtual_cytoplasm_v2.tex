...
\section*{Discussion}\label{sec:dissc}
 ...
 \begin{itemize}
  ...
  \item Diffusion coefficient is significantly different, and it's independent of the size of the proteins (D_cyto/D_single plot in Supp. Info.). Based on the observations above (sasa, gyration, rmsd, rmsf) the drop is, to a greater amount, due to the excluded volume effect, and to a lesser amount, due electristatic interactions that has been compromised because of choice of force field. 
