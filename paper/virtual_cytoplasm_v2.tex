...
Except for some local unfolding for TufA, all crowders were stable during the simulations (Figure \ref{fig:structural_integrity_chain}) and their flexibility profile doesn't change significantly (Figure \ref{fig:rmsf}) when compared to the dilute condition. This shows that our cytoplasm model is stable even in the microsecond range.
