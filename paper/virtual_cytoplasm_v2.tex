...
structural dynamics of an all-atom explicit solvent cytoplasm model {\color{blue} of {\em E. coli}}
...
crowded environment. The value of the root mean square deviation considering only
